...
import { _ as _RefWithState, a as _DataSourceOptions, R as ResetOption, b as _Nullable, c as _FirestoreDataSource } from './shared/vuefire.bc0096f5.js';
 ...
 */
declare function useDatabaseList<T = unknown>(reference: MaybeRefOrGetter<_Nullable<DatabaseReference | Query>>, options?: UseListOptions): _RefDatabase<VueDatabaseQueryData<T>>;
/**
 ...
 * @param options - optional options
 */
declare function useDatabaseObject<T = unknown>(reference: MaybeRefOrGetter<_Nullable<DatabaseReference>>, options?: UseObjectOptions): _RefDatabase<VueDatabaseDocumentData<T> | undefined>;
/**
 ...
 * @param options - optional options
 */
declare function useCollection<R extends CollectionReference<unknown> | Query$1<unknown>>(collectionRef: MaybeRefOrGetter<_Nullable<R>>, options?: UseCollectionOptions): _RefFirestore<_InferReferenceType<R>[]>;
/**
 ...
 * @param options - optional options
 */
declare function useCollection<T>(collectionRef: MaybeRefOrGetter<_Nullable<CollectionReference | Query$1>>, options?: UseCollectionOptions): _RefFirestore<VueFirestoreQueryData<T>>;
 ...
 * @param options - optional options
 */
declare function useDocument<R extends DocumentReference<unknown>>(documentRef: MaybeRefOrGetter<_Nullable<R>>, options?: UseDocumentOptions): _RefFirestore<_InferReferenceType<R> | undefined>;
/**
 * Creates a reactive collection (usually an array) of documents from a collection ref or a query from Firestore.
 * Accepts a generic to **enforce the type** of the returned Ref. Note you can (and probably should) use
 * `.withConverter()` to have stricter type safe version of a collection reference.
 ...
 * @param options - optional options
 */
declare function useDocument<T>(documentRef: MaybeRefOrGetter<_Nullable<DocumentReference>>, options?: UseDocumentOptions): _RefFirestore<VueFirestoreDocumentData<T> | undefined>;
/**
 ...
 * @internal
 */
declare function _VueFireAuthInit(firebaseApp: FirebaseApp, app: App, initialUser: _Nullable<User>, dependencies: Dependencies): readonly [vue_demi.Ref<{
...
declare function useStorageFileUrl(storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>): {
    ...
    promise: vue_demi.Ref<Promise<string | null>> | vue_demi.ShallowRef<Promise<string | null>>;
};
/**
...
declare function useStorageFileMetadata(storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>): {
    ...
    promise: vue_demi.Ref<Promise<FullMetadata | null>> | vue_demi.ShallowRef<Promise<FullMetadata | null>>;
};
/**
