...
class TwoKConcept {
    constructor() {
        this.twoks = new doc_1.default("towks");
    ...
    create(rower) {
        return __awaiter(this, void 0, void 0, function* () {
            const _id = yield this.twoks.createOne({ rower, time: undefined });
            return { msg: "2K record successfully created!", record: yield this.twoks.readOne({ _id }) };
        });
    }
    getRecordById(_id) {
        return __awaiter(this, void 0, void 0, function* () {
            const record = yield this.twoks.readOne({ _id });
            if (record === null) {
    ...
    getTwoKs(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const records = yield this.twoks.readMany(query, {
                sort: { time: 1 },
            });
            return records;
        });
